...
output_model=model.fit_generator(training_flow, steps_per_epoch=27446//32,
                                 validation_data=validation_flow, validation_steps=3921//32,
                           epochs=4)
...
prediction=model.predict_generator(testing_flow, steps=total_test//32)
