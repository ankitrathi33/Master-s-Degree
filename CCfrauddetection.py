...
# Feature scaling using rubust scalar 
...
# So Random Forest with SMOTE performed better than Logistic Regression overall allowing us to get high recall and high precision at the same time.
